...
<?php $__env->startSection('data'); ?>
   ...
   <main>
      ...
      <section class="breadcrumb__area  breadcrumb__pt-310 include-bg p-relative"
         data-background="assets/img/about/ab-1.1.jpg">
            ...
            <div class="row ac-testimonial-space">
               ...
               <div class="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".5s" data-wow-delay=".7s">
                  <div class="ac-testimonial-right">
                     <img src="assets/img/about/ab-1.2.jpg" alt="">
                  </div>
               </div>
            </div>
         </div>
                  ...
                  <div class="tp-chose-item mb-30">
                     <div class="tpchosebox">
                        ...
                        <div class="tpchosebox__content">
                           <h4><a href="<?php echo e('service-details'); ?>">Professional <br> Team</a></h4>
                           <p>24+ Team Member</p>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow tpfadeUp" data-wow-duration=".5s" data-wow-delay=".7s">
                  <div class="tp-chose-item mb-30">
                     <div class="tpchosebox tpchosebox-three">
                        ...
                        <div class="tpchosebox__content">
                           <h4><a href="<?php echo e('service-details'); ?>">Competitive <br>
                              Rate</a></h4>
               ...
               <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                  <div class="tp-chose-item mb-30">
                     <div class="tpchosebox tpchosebox-two">
                        ...
                        <div class="tpchosebox__content">
                           <h4><a href="<?php echo e('service-details'); ?>">Cretified <br>
                              Globally</a></h4>
                           <p>65.04 k Reach</p>
                        </div>
                     </div>
               ...
               <div class="col-xl-3 col-lg-6 col-md-6 col-12 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                  <div class="tp-chose-item mb-30">
                     <div class="tpchosebox">
                        ...
                        <div class="tpchosebox__content">
                           <h4><a href="<?php echo e('service-details'); ?>">Competitive <br> Rate</a></h4>
                           <p>100% Client Satisfied</p>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-xl-3 col-lg-3 col-md-6">
                     <div class="acfeature mb-50">
                        ...
                        <div class="acfeature__item">
                           <h3 class="ac-feature-sm-title"><a href="<?php echo e('aboutme'); ?>">Project kikoff</a></h3>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6">
                     <div class="acfeature mb-50">
                        ...
                        <div class="acfeature__item">
                           <h3 class="ac-feature-sm-title ac-cirle-color-2"><a href="<?php echo e('aboutme'); ?>">PIdeation</a></h3>
                           <p>At collax we specialize designing building, shipping...</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-md-6">
                     <div class="acfeature mb-50">
                        ...
                        <div class="acfeature__item">
                           <h3 class="ac-feature-sm-title ac-cirle-color-3"><a href="<?php echo e('aboutme'); ?>">Design Process</a></h3>
                           <p>At collax we specialize designing building, shipping...</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-md-6">
                     <div class="acfeature mb-50">
                        ...
                        <div class="acfeature__item">
                           <h3 class="ac-feature-sm-title ac-cirle-color-4"><a href="<?php echo e('aboutme'); ?>">Development</a></h3>
                           <p>At collax we specialize designing building, shipping...</p>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 wow tpfadeUp" data-wow-duration=".3s" data-wow-delay=".5s">
                  <div class="tpteam mb-30">
                     ...
                     <div class="tpteam__thumb">
                        <img class="w-100" src="assets/img/about/team-1.jpg" alt="">
                     </div>
                     <div class="tpteam__content">
                        <h4 class="tp-team-sm-title"><a href="<?php echo e("portfolioDetail"); ?>">Alextina Derexine</a></h4>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 wow tpfadeUp" data-wow-duration=".5s" data-wow-delay=".7s">
                  <div class="tpteam mb-30">
                     ...
                     <div class="tpteam__thumb">
                        <img class="w-100" src="assets/img/about/team-5.1.jpg" alt="">
                     </div>
                     <div class="tpteam__content">
                        <h4 class="tp-team-sm-title"><a href="<?php echo e("portfolioDetail"); ?>">Darrell Steward</a></h4>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".9s">
                  <div class="tpteam mb-30">
                     ...
                     <div class="tpteam__thumb">
                        <img class="w-100" src="assets/img/about/team-5.2.jpg" alt="">
                     </div>
                     <div class="tpteam__content">
                        <h4 class="tp-team-sm-title"><a href="<?php echo e("portfolioDetail"); ?>">Floyd Miles</a></h4>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 wow tpfadeUp" data-wow-duration=".8s" data-wow-delay="1s">
                  <div class="tpteam mb-30">
                     ...
                     <div class="tpteam__thumb">
                        <img class="w-100" src="assets/img/about/team-7.jpg" alt="">
                     </div>
                     <div class="tpteam__content">
                        <h4 class="tp-team-sm-title"><a href="<?php echo e("portfolioDetail"); ?>">Albert Flores</a></h4>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                  <div class="tpteam mb-30">
                     ...
                     <div class="tpteam__thumb">
                        <img class="w-100" src="assets/img/about/team-2.jpg" alt="">
                     </div>
                     <div class="tpteam__content">
                        <h4 class="tp-team-sm-title"><a href="<?php echo e("portfolioDetail"); ?>">Dianne Russell</a></h4>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 wow tpfadeUp" data-wow-duration="1s" data-wow-delay="1.2s">
                  <div class="tpteam mb-30">
                     ...
                     <div class="tpteam__content">
                        <h4 class="tp-team-sm-title"><a href="<?php echo e("portfolioDetail"); ?>">Jerome Bell</a></h4>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 wow tpfadeUp" data-wow-duration=".1.1s" data-wow-delay="1.3s">
                  <div class="tpteam mb-30">
                     ...
                     <div class="tpteam__thumb">
                        <img class="w-100" src="assets/img/about/team-4.jpg" alt="">
                     </div>
                     <div class="tpteam__content">
                        <h4 class="tp-team-sm-title"><a href="<?php echo e("portfolioDetail"); ?>">Robert Fox</a></h4>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 wow tpfadeUp" data-wow-duration=".1.2s" data-wow-delay="1.4s">
                  <div class="tpteam mb-30">
                     ...
                     <div class="tpteam__thumb">
                        <img class="w-100" src="assets/img/about/team-5.jpg" alt="">
                     </div>
                     <div class="tpteam__content">
                        <h4 class="tp-team-sm-title"><a href="<?php echo e("portfolioDetail"); ?>">Farhan Firoz</a></h4>
                        <h5 class="tp-team-sm-subtitle"><a href="#">Web Designer</a></h5>
                        <a href="#"><i class="fab fa-youtube"></i></a>
                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                        <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="row align-items-center">
               <div class="col-xl-7 col-lg-7 col-md-12 ">
                  <div class="tp-news-sub-wrapper pr-50">
                     ...
                     <div class="tp-news-button wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                        ...
                        <a class="tp-btn-sky" href="<?php echo e('aboutme'); ?>">Press Office</a>
                     </div>
                  </div>
               </div>
               <div class="col-xl-5 col-lg-5 col-md-12 wow tpfadeRight" data-wow-duration=".5s" data-wow-delay=".8s">
                  <div class="tp-news-letter-img text-md-start text-lg-end pr-45">
                     <img src="assets/img/about/news-7.1.png" alt="">
                  </div>
               </div>
            </div>
         </div>
   ...
   <!-- footer-area-start -->
   <?php $__env->stopSection(); ?>
<?php echo $__env->make('user.partisls.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\authapp\resources\views/user/about.blade.php ENDPATH**/ ?>