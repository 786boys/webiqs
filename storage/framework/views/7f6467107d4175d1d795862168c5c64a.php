...
<?php $__env->startSection('data'); ?>
                  ...
                  <div class="postbox__wrapper pr-20">
                     <article class="postbox__item format-image mb-50 transition-3">
                        <div class="postbox__thumb w-img">
                           <a href="<?php echo e('blogdetail'); ?>">
                              <img src="<?php echo e(asset('user/assets/img/blog/blog-big-1.jpg')); ?>" alt="">
                           </a>
                        </div>
                        <div class="postbox__content">
                           ...
                           <h3 class="postbox__title">
                              <a href="<?php echo e('blogdetail'); ?>">How To Create A Vanilla JavaScript Gantt Chart: Adding Task Editing Features (Part 2)</a>
                           </h3>
                           ...
                           <div class="post__button">
                              <a class="tp-btn-yellow" href="<?php echo e('blogdetail'); ?>"> READ MORE</a>
                           </div>
                        </div>
                     </article>
                     <article class="postbox__item format-image mb-50 transition-3 fix">
                        <div class="swiper-container blog-post-slider-active">
                           <div class="swiper-wrapper">
                              ...
                              <div class="swiper-slide">
                                 <img src="<?php echo e(asset('user/assets/img/blog/blog-big-2.jpg')); ?>" alt="">
                              </div>
                              <div class="swiper-slide">
                                 <img src="<?php echo e(asset('user/assets/img/blog/blog-big-3.jpg')); ?>" alt="">
                              </div>
                           </div>
                        ...
                        <div class="postbox__content">
                           ...
                           <h3 class="postbox__title">
                              <a href="<?php echo e('blogdetail'); ?>">How To Apply UX Principles To Embedded Systems: Learnings From The Field</a>
                           </h3>
                           <div class="postbox__text">
                              <p>Laboratories used for scientific research take many forms because of the differing requirements of specialists in the various fields of science and engineering. A physics laboratory</p>
                           </div>
                     ...
                     <article class="postbox__item format-video mb-50 transition-3">
                        ...
                        <div class="postbox__content">
                           ...
                           <h3 class="postbox__title">
                              <a href="<?php echo e('blogdetail'); ?>">DevFest For Ukraine, A Charity Conference On The Future Of Tech </a>
                           </h3>
                           <div class="postbox__text">
                              <p>Laboratories used for scientific research take many forms because of the differing requirements of specialists in the various fields of science and engineering. A physics laboratory</p>
                           </div>
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4">
                  <div class="sidebar__wrapper">
                     ...
                     <div class="sidebar__widget mb-40">
                        ...
                        <div class="sidebar__widget-content">
                           <ul>
                              <li><a href="<?php echo e('blog'); ?>">Web Design<span>26</span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">Devlopment <span>30</span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">Branding <span>71</span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">MOtion Design <span>56</span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">UI/UX Deisgn <span>60</span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">Graphic Design <span>99</span></a></li>
                           </ul>
                        </div>
                     </div>
                     <div class="sidebar__widget mb-40">
                        ...
                        <div class="sidebar__widget-content">
                           <ul>
                              <li><a href="<?php echo e('blog'); ?>">Web Design <span><i class="fal fa-angle-right"></i></span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">Devlopment <span><i class="fal fa-angle-right"></i></span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">Branding <span><i class="fal fa-angle-right"></i></span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">MOtion Design<span><i class="fal fa-angle-right"></i></span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">UI/UX Deisgn  <span><i class="fal fa-angle-right"></i></span></a></li>
                              <li><a href="<?php echo e('blog'); ?>">Graphic Design  <span><i class="fal fa-angle-right"></i></span></a></li>
                           </ul>
                        </div>
                     </div>
                     <div class="sidebar__widget mb-40">
                           ...
                           <div class="sidebar__post rc__post">
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="<?php echo e('blogdetail'); ?>"><img src="<?php echo e(asset('user/assets/img/blog/blog-sm-1.jpg')); ?>" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    ...
                                    <h3 class="rc__post-title">
                                       <a href="<?php echo e('blogdetail'); ?>">Don’t Underestimate The Software</a>
                                    </h3>
                                 </div>
                              </div>
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="<?php echo e('blogdetail'); ?>"><img src="<?php echo e(asset('user/assets/img/blog/blog-sm-2.jpg')); ?>" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                       <span>4 March. 2022</span>
                                    ...
                                    <h3 class="rc__post-title">
                                       <a href="<?php echo e('blogdetail'); ?>">Designing Human-Machine Interfaces..</a>
                                    </h3>
                                 </div>
                              </div>
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="<?php echo e('blogdetail'); ?>"><img src="<?php echo e(asset('user/assets/img/blog/blog-sm-3.jpg')); ?>" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                       <span>4 March. 2022</span>
                                    ...
                                    <h3 class="rc__post-title">
                                       <a href="<?php echo e('blogdetail'); ?>">Web Design Done Well: Excellent</a>
                                    </h3>
                                 </div>
                              </div>
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="<?php echo e('blogdetail'); ?>"><img src="<?php echo e(asset('user/assets/img/blog/blog-sm-4.jpg')); ?>" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                       <span>4 March. 2022</span>
                     ...
                     <div class="sidebar__widget mb-40">
                        ...
                        <div class="sidebar__widget-content">
                           <div class="tagcloud">
                              <a href="<?php echo e('blog'); ?>">landing</a>
                              <a href="<?php echo e('blog'); ?>">Charity</a>
                              <a href="<?php echo e('blog'); ?>">apps</a>
                              <a href="<?php echo e('blog'); ?>">Education </a>
                              <a href="<?php echo e('blog'); ?>">data</a>
                              <a href="<?php echo e('blog'); ?>">book</a>
                              <a href="<?php echo e('blog'); ?>">Design</a>
                              <a href="<?php echo e('blog'); ?>">website</a>
                              <a href="<?php echo e('blog'); ?>">landing page</a>
                              <a href="<?php echo e('blog'); ?>">data</a>
                           </div>
                        </div>
                     </div>
   ...
   <?php $__env->stopSection(); ?>
<?php echo $__env->make('user.partisls.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\authapp\resources\views/user/blog.blade.php ENDPATH**/ ?>