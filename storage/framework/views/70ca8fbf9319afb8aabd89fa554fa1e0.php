      ...
      <div class="container-fluid p-0">
         ...
         <div class="row grid gx-0 port-space">
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat2 cat3">
              <div class="bp-project-item p-relative">
                  <div class="bp-project-img w-img fix">
                     <img src="<?php echo e(asset('user/assets/img/portfolio/port-10.jpg')); ?>" alt="">
                  </div>
                  <div class="bp-project-item-link">
                     <span>
                         <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/port-10.jpg')); ?>">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat5">
              <div class="bp-project-item p-relative">
                  <div class="bp-project-img w-img fix">
                     <img src="<?php echo e(asset('user/assets/img/portfolio/port-11.jpg.jpg')); ?>" alt="">
                  </div>
                  <div class="bp-project-item-link">
                     <span>
                         <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/port-11.jpg.jpg')); ?>">
                           <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M0.224823 95.4633L11.3577 106.62C11.8638 107.127 14.9002 107.127 15.406 106.62L80.1796 43.2308C81.1916 42.2165 82.2038 41.7093 83.7219 41.7093C84.228 41.7093 85.2402 41.7093 85.746 42.2165C87.7702 42.7236 88.7822 44.7521 88.7822 46.7805V78.7286V79.2358H104.976C105.988 79.2358 106.494 79.2358 107 79.2358V1.64818C107 1.64818 107 1.64819 105.988 0.633841C104.976 -0.380504 105.482 0.126918 104.47 0.126918H28.5633C28.5633 0.633841 28.5633 1.14101 28.5633 2.66253V18.3826C28.5633 19.3967 28.5633 20.4111 28.5633 20.4111H60.9501C62.9743 20.4111 64.9984 21.4252 65.5043 23.4536C66.5163 25.482 66.0104 27.5105 64.4923 29.032L1.23705 91.9136C0.730947 92.4208 0.224823 92.928 0.224823 93.9421C-0.281034 94.9561 0.224823 94.9562 0.224823 95.4633Z" fill="currentColor"/>
                           </svg>
                         </a>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat3">
              <div class="bp-project-item p-relative">
                  <div class="bp-project-img w-img fix">
                     <img src="<?php echo e(asset('user/assets/img/portfolio/port-12 (1).jpg')); ?>" alt="">
                  </div>
                  <div class="bp-project-item-link">
                     <span>
                         <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/port-12 (1).jpg')); ?>">
                           <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M0.224823 95.4633L11.3577 106.62C11.8638 107.127 14.9002 107.127 15.406 106.62L80.1796 43.2308C81.1916 42.2165 82.2038 41.7093 83.7219 41.7093C84.228 41.7093 85.2402 41.7093 85.746 42.2165C87.7702 42.7236 88.7822 44.7521 88.7822 46.7805V78.7286V79.2358H104.976C105.988 79.2358 106.494 79.2358 107 79.2358V1.64818C107 1.64818 107 1.64819 105.988 0.633841C104.976 -0.380504 105.482 0.126918 104.47 0.126918H28.5633C28.5633 0.633841 28.5633 1.14101 28.5633 2.66253V18.3826C28.5633 19.3967 28.5633 20.4111 28.5633 20.4111H60.9501C62.9743 20.4111 64.9984 21.4252 65.5043 23.4536C66.5163 25.482 66.0104 27.5105 64.4923 29.032L1.23705 91.9136C0.730947 92.4208 0.224823 92.928 0.224823 93.9421C-0.281034 94.9561 0.224823 94.9562 0.224823 95.4633Z" fill="currentColor"/>
                           </svg>
                         </a>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat5">
              <div class="bp-project-item p-relative">
                  <div class="bp-project-img w-img fix">
                     <img src="<?php echo e(asset('user/assets/img/portfolio/port-13 (1).jpg')); ?>" alt="">
                  </div>
                  <div class="bp-project-item-link">
                     <span>
                         <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/port-13 (1).jpg')); ?>">
                           <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M0.224823 95.4633L11.3577 106.62C11.8638 107.127 14.9002 107.127 15.406 106.62L80.1796 43.2308C81.1916 42.2165 82.2038 41.7093 83.7219 41.7093C84.228 41.7093 85.2402 41.7093 85.746 42.2165C87.7702 42.7236 88.7822 44.7521 88.7822 46.7805V78.7286V79.2358H104.976C105.988 79.2358 106.494 79.2358 107 79.2358V1.64818C107 1.64818 107 1.64819 105.988 0.633841C104.976 -0.380504 105.482 0.126918 104.47 0.126918H28.5633C28.5633 0.633841 28.5633 1.14101 28.5633 2.66253V18.3826C28.5633 19.3967 28.5633 20.4111 28.5633 20.4111H60.9501C62.9743 20.4111 64.9984 21.4252 65.5043 23.4536C66.5163 25.482 66.0104 27.5105 64.4923 29.032L1.23705 91.9136C0.730947 92.4208 0.224823 92.928 0.224823 93.9421C-0.281034 94.9561 0.224823 94.9562 0.224823 95.4633Z" fill="currentColor"/>
                           </svg>
                         </a>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat2 cat5cat3">
              <div class="bp-project-item p-relative">
                  <div class="bp-project-img w-img fix">
                     <img src="<?php echo e(asset('user/assets/img/portfolio/port-14 (1).jpg')); ?>" alt="">
                  </div>
                  <div class="bp-project-item-link">
                     <span>
                         <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/port-14 (1).jpg')); ?>">
                           <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M0.224823 95.4633L11.3577 106.62C11.8638 107.127 14.9002 107.127 15.406 106.62L80.1796 43.2308C81.1916 42.2165 82.2038 41.7093 83.7219 41.7093C84.228 41.7093 85.2402 41.7093 85.746 42.2165C87.7702 42.7236 88.7822 44.7521 88.7822 46.7805V78.7286V79.2358H104.976C105.988 79.2358 106.494 79.2358 107 79.2358V1.64818C107 1.64818 107 1.64819 105.988 0.633841C104.976 -0.380504 105.482 0.126918 104.47 0.126918H28.5633C28.5633 0.633841 28.5633 1.14101 28.5633 2.66253V18.3826C28.5633 19.3967 28.5633 20.4111 28.5633 20.4111H60.9501C62.9743 20.4111 64.9984 21.4252 65.5043 23.4536C66.5163 25.482 66.0104 27.5105 64.4923 29.032L1.23705 91.9136C0.730947 92.4208 0.224823 92.928 0.224823 93.9421C-0.281034 94.9561 0.224823 94.9562 0.224823 95.4633Z" fill="currentColor"/>
                           </svg>
                         </a>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat3 cat4">
              <div class="bp-project-item p-relative">
                  <div class="bp-project-img w-img fix">
                     <img src="<?php echo e(asset('user/assets/img/portfolio/port-15 (1).jpg')); ?>" alt="">
                  </div>
                  <div class="bp-project-item-link">
                     <span>
                         <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/port-15 (1).jpg')); ?>">
                           <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M0.224823 95.4633L11.3577 106.62C11.8638 107.127 14.9002 107.127 15.406 106.62L80.1796 43.2308C81.1916 42.2165 82.2038 41.7093 83.7219 41.7093C84.228 41.7093 85.2402 41.7093 85.746 42.2165C87.7702 42.7236 88.7822 44.7521 88.7822 46.7805V78.7286V79.2358H104.976C105.988 79.2358 106.494 79.2358 107 79.2358V1.64818C107 1.64818 107 1.64819 105.988 0.633841C104.976 -0.380504 105.482 0.126918 104.47 0.126918H28.5633C28.5633 0.633841 28.5633 1.14101 28.5633 2.66253V18.3826C28.5633 19.3967 28.5633 20.4111 28.5633 20.4111H60.9501C62.9743 20.4111 64.9984 21.4252 65.5043 23.4536C66.5163 25.482 66.0104 27.5105 64.4923 29.032L1.23705 91.9136C0.730947 92.4208 0.224823 92.928 0.224823 93.9421C-0.281034 94.9561 0.224823 94.9562 0.224823 95.4633Z" fill="currentColor"/>
                           </svg>
                         </a>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat3">
              <div class="bp-project-item p-relative">
                  <div class="bp-project-img w-img fix">
                     <img src="<?php echo e(asset('user/assets/img/portfolio/port-16 (1).jpg')); ?>" alt="">
                  </div>
                  <div class="bp-project-item-link">
                     <span>
                         <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/port-16 (1).jpg')); ?>">
                           <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M0.224823 95.4633L11.3577 106.62C11.8638 107.127 14.9002 107.127 15.406 106.62L80.1796 43.2308C81.1916 42.2165 82.2038 41.7093 83.7219 41.7093C84.228 41.7093 85.2402 41.7093 85.746 42.2165C87.7702 42.7236 88.7822 44.7521 88.7822 46.7805V78.7286V79.2358H104.976C105.988 79.2358 106.494 79.2358 107 79.2358V1.64818C107 1.64818 107 1.64819 105.988 0.633841C104.976 -0.380504 105.482 0.126918 104.47 0.126918H28.5633C28.5633 0.633841 28.5633 1.14101 28.5633 2.66253V18.3826C28.5633 19.3967 28.5633 20.4111 28.5633 20.4111H60.9501C62.9743 20.4111 64.9984 21.4252 65.5043 23.4536C66.5163 25.482 66.0104 27.5105 64.4923 29.032L1.23705 91.9136C0.730947 92.4208 0.224823 92.928 0.224823 93.9421C-0.281034 94.9561 0.224823 94.9562 0.224823 95.4633Z" fill="currentColor"/>
                           </svg>
                         </a>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat5">
              <div class="bp-project-item p-relative">
                  <div class="bp-project-img w-img fix">
                     <img src="<?php echo e(asset('user/assets/img/portfolio/port-17 (1).jpg')); ?>" alt="">
                  </div>
                  <div class="bp-project-item-link">
                     <span>
                         <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/port-17 (1).jpg')); ?>">
                           <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M0.224823 95.4633L11.3577 106.62C11.8638 107.127 14.9002 107.127 15.406 106.62L80.1796 43.2308C81.1916 42.2165 82.2038 41.7093 83.7219 41.7093C84.228 41.7093 85.2402 41.7093 85.746 42.2165C87.7702 42.7236 88.7822 44.7521 88.7822 46.7805V78.7286V79.2358H104.976C105.988 79.2358 106.494 79.2358 107 79.2358V1.64818C107 1.64818 107 1.64819 105.988 0.633841C104.976 -0.380504 105.482 0.126918 104.47 0.126918H28.5633C28.5633 0.633841 28.5633 1.14101 28.5633 2.66253V18.3826C28.5633 19.3967 28.5633 20.4111 28.5633 20.4111H60.9501C62.9743 20.4111 64.9984 21.4252 65.5043 23.4536C66.5163 25.482 66.0104 27.5105 64.4923 29.032L1.23705 91.9136C0.730947 92.4208 0.224823 92.928 0.224823 93.9421C-0.281034 94.9561 0.224823 94.9562 0.224823 95.4633Z" fill="currentColor"/>
                           </svg>
                         </a>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat3 cat4">
               <div class="bp-project-item p-relative">
                   <div class="bp-project-img w-img fix">
                      <img src="<?php echo e(asset('user/assets/img/portfolio/project-6.1.jpg')); ?>" alt="">
                   </div>
                   <div class="bp-project-item-link">
                      <span>
                          <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/project-6.1.jpg')); ?>">
                            <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                               <path d="M0.224823 95.4633L11.3577 106.62C11.8638 107.127 14.9002 107.127 15.406 106.62L80.1796 43.2308C81.1916 42.2165 82.2038 41.7093 83.7219 41.7093C84.228 41.7093 85.2402 41.7093 85.746 42.2165C87.7702 42.7236 88.7822 44.7521 88.7822 46.7805V78.7286V79.2358H104.976C105.988 79.2358 106.494 79.2358 107 79.2358V1.64818C107 1.64818 107 1.64819 105.988 0.633841C104.976 -0.380504 105.482 0.126918 104.47 0.126918H28.5633C28.5633 0.633841 28.5633 1.14101 28.5633 2.66253V18.3826C28.5633 19.3967 28.5633 20.4111 28.5633 20.4111H60.9501C62.9743 20.4111 64.9984 21.4252 65.5043 23.4536C66.5163 25.482 66.0104 27.5105 64.4923 29.032L1.23705 91.9136C0.730947 92.4208 0.224823 92.928 0.224823 93.9421C-0.281034 94.9561 0.224823 94.9562 0.224823 95.4633Z" fill="currentColor"/>
                            </svg>
                          </a>
             ...
             <div class="col-xl-6 col-lg-6 col-md-6 grid-item cat2">
               <div class="bp-project-item p-relative">
                   <div class="bp-project-img w-img fix">
                      <img src="<?php echo e(asset('user/assets/img/portfolio/port-18 (1).jpg')); ?>" alt="">
                   </div>
                   <div class="bp-project-item-link">
                      <span>
                          <a class="popup-image" href="<?php echo e(asset('user/assets/img/portfolio/port-18 (1).jpg')); ?>">
                            <svg width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
                               <path d="M0.224823 95.4633L11.3577 106.62C11.8638 107.127 14.9002 107.127 15.406 106.62L80.1796 43.2308C81.1916 42.2165 82.2038 41.7093 83.7219 41.7093C84.228 41.7093 85.2402 41.7093 85.746 42.2165C87.7702 42.7236 88.7822 44.7521 88.7822 46.7805V78.7286V79.2358H104.976C105.988 79.2358 106.494 79.2358 107 79.2358V1.64818C107 1.64818 107 1.64819 105.988 0.633841C104.976 -0.380504 105.482 0.126918 104.47 0.126918H28.5633C28.5633 0.633841 28.5633 1.14101 28.5633 2.66253V18.3826C28.5633 19.3967 28.5633 20.4111 28.5633 20.4111H60.9501C62.9743 20.4111 64.9984 21.4252 65.5043 23.4536C66.5163 25.482 66.0104 27.5105 64.4923 29.032L1.23705 91.9136C0.730947 92.4208 0.224823 92.928 0.224823 93.9421C-0.281034 94.9561 0.224823 94.9562 0.224823 95.4633Z" fill="currentColor"/>
                            </svg>
                          </a>
