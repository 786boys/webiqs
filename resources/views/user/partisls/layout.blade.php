...
<head>
   ...
   <link rel="stylesheet" href="{{asset('user/assets/css/custom-animation.css')}}">
         ...
         <div class="container-fluid">
            <div class="row align-items-center">
               <div class="col-xl-3 col-lg-3">
                  <div class="tp-logo">
                     <a href="{{'/'}}"><img src="{{asset('user/assets/img/logo/logo.png')}}" alt="h"></a>
                  </div>
               </div>
                     ...
                     <nav id="mobile-menu">
                        <ul>
                           ...
                           <li class=" "><a href="{{'/blog'}}">Blog</a>
                              {{-- <ul class="submenu text-start">
                                 <li><a href="{{'blog'}}">Blog Sidebar</a></li>
                           ...
                           <li class="has-dropdown has-menu"><a href="#">More</a>
                              <ul class="submenu text-start">
                                 ...
                                 {{-- <li><a href="{{'service-2'}}">Service 02</a></li> --}}
                                 {{-- <li><a href="{{'service-3'}}">Service 03</a></li> --}}
                                 {{-- <li><a href="{{'service-4'}}">Service 04</a></li> --}}
                  ...
                  <div class="row align-items-center">
                     <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                        <div class="tp-copyright-logo mt-35">
                           <a href="{{'/'}}"><img src="assets/img/copyright/copyright-logo.png" alt=""></a>
                        </div>
                     </div>
