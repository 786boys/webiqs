                  ...
                  <div class="postbox__wrapper">
                     <article class="postbox__item format-image transition-3">
                        <div class="postbox__content">
                           <p><img class="w-100" src="{{asset('user/assets/img/blog-details/blog-big-1.jpg')}}" alt=""></p>
                           ...
                           <div class="postbox__thumb2">
                              <div class="row gx-50">
                                 <div class="col-xl-6">
                                    <p><img src="{{asset('user/assets/img/blog-details/blog-big-4 (1).jpg')}}" alt=""></p>
                                 </div>
                                 <div class="col-xl-6">
                                    <p><img src="{{asset('user/assets/img/blog-details/blog-sm-5 (1).jpg')}}" alt=""></p>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="row">
                                 <div class="col-xl-6 col-lg-12">
                                    <div class="postbox__tag tagcloud">
                                       <span>Tag</span>
                                       <a href="{{'blogdetail'}}">Business</a>
                                       <a href="{{'blogdetail'}}">Design</a>
                                       <a href="{{'blogdetail'}}">apps</a>
                                       <a href="{{'blogdetail'}}">data</a>
                                    </div>
                                 </div>
                                 <div class="col-xl-6 col-lg-12">
                                    <div class="postbox__social text-xl-end text-start">
                                       <span>Share</span>
                                       <a href="{{'blogdetail'}}"><i class="fab fa-linkedin tp-linkedin"></i></a>
                                       <a href="{{'blogdetail'}}"><i class="fab fa-pinterest tp-pinterest"></i></a>
                                       <a href="{{'blogdetail'}}"><i class="fab fa-facebook tp-facebook" ></i></a>
                                       <a href="{{'blogdetail'}}"><i class="fab fa-twitter tp-twitter"></i></a>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="sidebar__post rc__post">
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="{{'blogdetail'}}"><img src="{{asset('user/assets/img/blog-details/blog-sm-1 (1).jpg')}}" alt=""></a>
                                 </div>
                              ...
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="{{'blogdetail'}}"><img src="{{asset('user/assets/img/blog-details/blog-sm-2 (1).jpg')}}" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                       <span>4 March. 2022</span>
                              ...
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="{{'blogdetail'}}"><img src="{{asset('user/assets/img/blog-details/blog-sm-3 (1).jpg')}}" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                       <span>4 March. 2022</span>
                              ...
                              <div class="rc__post mb-20 d-flex align-items-center">
                                 <div class="rc__post-thumb mr-20">
                                    <a href="{{'blogdetail'}}"><img src="{{asset('user/assets/img/blog-details/blog-big-4 (1).jpg')}}" alt=""></a>
                                 </div>
                                 <div class="rc__post-content">
                                    <div class="rc__meta">
                                       <span>4 March. 2022</span>
