...
@section('data')
   ...
   <div class="tp-hero-area tp-hero-space p-relative z-index-1 fix">
      <div class="tp-hero-shape">
         ...
         <div class="shape-one"><img src="{{asset('user/assets/img/hero/shape-1.png')}}" alt=""></div>
      </div>
            ...
            <div class="row align-items-center">
                  ...
                  <div class="tp-hero-content">
                     <div class="tp-hero-text">
                        ...
                        <div class="tp-hero-button mb-140 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                           <a class="tp-btn mr-30" href="{{"portfolioDetail"}}">Visit Case Studies</a>
                           <a class="tp-btn-grey" href="{{'aboutme'}}">About Collax <i class="far fa-arrow-right"></i></a>
                        </div>
               ...
               <div class="col-xl-5 col-lg-5">
                  <div class="tp-hero-big-img wow fadeInRight"  data-wow-duration=".7s" data-wow-delay="1.2s">
                     <img src="{{asset('user/assets/img/hero/hero-2.png')}}" alt="">
                  </div>
               </div>
            </div>
         </div>
   ...
   <div class="p-relative">
      <div class="shape-two z-index-1">
         <img src="{{asset('user/assets/img/hero/shape-2.png')}}" alt="">
         </div>
      <div class="tp-creative-area p-relative black-bg pt-140 pb-135 fix">
         ...
         <div class="creative-shape-img">
            <img src="{{asset('user/assets/img/creative/creative-hand.png')}}" alt="">
            </div>
         <div class="creative-shape-img-2">
            <img src="{{asset('user/assets/img/creative/creative-circle-img.png')}}" alt="">
            </div>
               ...
               <div class="swiper-wrapper d-flex align-items-center">
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="{{asset('user/assets/img/brand/brand-1.png')}}" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="{{asset('user/assets/img/brand/brand-2.png')}}" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="{{asset('user/assets/img/brand/brand-3.png')}}" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="{{asset('user/assets/img/brand/brand-4.png')}}" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="{{asset('user/assets/img/brand/brand-5.png')}}" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
                        <img src="{{asset('user/assets/img/brand/brand-6.png')}}" alt="">
                     </div>
                  </div>
                  <div class="swiper-slide">
                     <div class="tp-brand-icon text-center">
   ...
   <div class="tp-service-area pt-190 pb-100 grey-bg p-relative fix">
      <div class="tp-sv-shape-img z-index-1">
         <img src="{{asset('user/assets/img/service/service-shape.png')}}" alt="">
      </div>
         ...
         <div class="row">
            <div class="col-lg-6 col-md-12 col-12">
               <div class="tp-service-section-box mb-30 wow tpfadeUp" data-wow-duration=".3s" data-wow-delay=".6s">
                  ...
                  <a class="tp-btn" href="{{'service-details'}}">View All Services</a>
               </div>
            </div>
            <div class="col-lg-6 col-md-12 col-12">
               <div class="tp-sv-box  wow tpfadeUp" data-wow-duration=".5s" data-wow-delay=".8s">
                  <div class="tp-service-item d-flex mb-30">
                     <div class="tp-sv-img">
                        <img src="{{asset('user/assets/img/service/service-1.png')}}" alt="">
                     </div>
                     <div class="tp-sv-content pl-60">
                        <h3 class=" tp-sv-title mb-35"><a href="{{'service-details'}}">Ideation & Evaluation</a></h3>
                        ...
                        <div class="tp-sv-link mt-35">
                           <a href="{{'service-details'}}"><i class="far fa-arrow-right"></i> Learn More</a>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-lg-6 col-md-12 col-12">
               <div class="tp-sv-box wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                  <div class="tp-service-item d-flex mb-30">
                     <div class="tp-sv-img">
                        <img src="{{asset('user/assets/img/service/service-2.png')}}" alt="">
                     </div>
                     <div class="tp-sv-content pl-60">
                           <h3 class="tp-sv-title mb-35"><a href="{{'service-details'}}">Design, Development</a></h3>
                        <p class="mb-30">At Collax we specialize in designing, building, shipping and scaling
                           beautiful,
                           usable products with blazing-fast</p>
                        <p>At Collax we specialize in designing, building, shipping and scaling...</p>
                        <div class="tp-sv-link mt-35">
                           <a href="{{'service-3'}}"><i class="far fa-arrow-right"></i> Learn More</a>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-lg-6 col-md-12 col-12">
               <div class="tp-sv-box wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1.2s">
                  <div class="tp-service-item d-flex mb-30">
                     <div class="tp-sv-img">
                        <img src="{{asset('user/assets/img/service/service-3.png')}}" alt="">
                     </div>
                     <div class="tp-sv-content pl-60">
                           <h3 class=" tp-sv-title mb-35"><a href="{{'service-details'}}">Online Marketing</a></h3>
                        <p class="mb-30">At Collax we specialize in designing, building, shipping and scaling
                           beautiful,
                           usable products with blazing-fast</p>
                        <p>At Collax we specialize in designing, building, shipping and scaling...</p>
                        <div class="tp-sv-link mt-35">
                           <a href="{{'service-4'}}"><i class="far fa-arrow-right"></i> Learn More</a>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <div class="tp-project-area p-relative pt-130 pb-100">
      <div class="tp-project-shape">
         <img src="{{asset('user/assets/img/project/project-shape.png')}}" alt="">
      </div>
      <div class="container">
                     ...
                     <div class="col-xl-6 col-lg-12">
                        <div class="tp-project-box mb-20">
                           <div class="tp-project-img fix mb-45">
                              <img class="w-100" src="{{asset('user/assets/img/project/brand-1.jpg')}}" alt="">
                           </div>
                           <div class="tp-project-content ml-20">
                              <h2 class="pro-lg-title"><a href="{{"portfolioDetail"}}">Hosting Website Design</a></h2>
                              <p>At Collax we specialize in designing, building, shipping...</p>
                              <a class="tp-btn-sm" href="{{'contect'}}">View Case Studies <i class="far fa-arrow-right"></i></a>
                           </div>
                        </div>
                     </div>
                     <div class="col-xl-6 col-lg-12">
                        <div class="row">
                           <div class=" col-xl-12 col-lg-12">
                              <div class="tp-project-box-sm d-flex align-items-center mb-20">
                                 <div class="tp-project-sm-img fix ml-25 mr-35">
                                    <img src="{{asset('user/assets/img/project/app-2.jpg')}}" alt="">
                                 </div>
                                 <div class="tp-project-sm-content">
                                    <h3 class="pro-sm-title"><a href="{{"portfolioDetail"}}">Medical Website</a></h3>
                                    <p>At Collax we specialize in the most designing, building, shipping...</p>
                                    <a class="tp-btn-white-sm" href="{{"portfolioDetail"}}">Case Studies <i
                           ...
                           <div class="col-xl-12 col-lg-12">
                              <div class="tp-project-box-sm d-flex align-items-center">
                                 <div class="tp-project-sm-img fix ml-25 mr-35">
                                    <img src="{{asset('user/assets/img/project/project-4.jpg')}}" alt="">
                                 </div>
                                 <div class="tp-project-sm-content">
                                    <h3 class="pro-sm-title"><a href="{{"portfolioDetail"}}">Pet Care Website</a></h3>
                                    <p>At Collax we specialize in the most designing, building, shipping...</p>
                                    <a class="tp-btn-white-sm" href="c{{"portfolioDetail"}}">Case Studies <i
                                          class="far fa-arrow-right"></i></a>
                                 </div>
                              </div>
                           </div>
               ...
               <div class="project-tab-main">
                  <div class="row gx-1  ">
                     <div class="col-xl-6 col-lg-12">
                        <div class="tp-project-box mb-20">
                           <div class="tp-project-img fix mb-45">
                              <img class="w-100" src="{{asset('user/assets/img/project/project-1.jpg')}}" alt="">
                           </div>
                           <div class="tp-project-content ml-20">
                              <h2 class="pro-lg-title"><a href="{{"portfolioDetail"}}">Hosting Website Design</a></h2>
                              <p>At Collax we specialize in designing, building, shipping...</p>
                              <a class="tp-btn-sm" href="{{"portfolioDetail"}}">View Case Studies <i class="far fa-arrow-right"></i></a>
                           </div>
                        </div>
                     </div>
                     <div class="col-xl-6 col-lg-12">
                        <div class="row">
                           <div class=" col-xl-12 col-lg-12">
                              <div class="tp-project-box-sm d-flex align-items-center mb-20">
                                 <div class="tp-project-sm-img fix ml-25 mr-35">
                                    <img src="{{asset('user/assets/img/project/project-2.jpg')}}" alt="">
                                 </div>
                                 <div class="tp-project-sm-content">
                                    <h3 class="pro-sm-title"><a href="{{"portfolioDetail"}}">Medical Website</a></h3>
                                    <p>At Collax we specialize in the most designing, building, shipping...</p>
               ...
               <div class="project-tab-main">
                  <div class="row gx-1  ">
                     <div class="col-xl-6 col-lg-12">
                        <div class="tp-project-box mb-20">
                           <div class="tp-project-img fix mb-45">
                              <img class="w-100" src="{{asset('user/assets/img/hero/brand-1.jpg')}}" alt="">
                           </div>
                           <div class="tp-project-content ml-20">
                              <h2 class="pro-lg-title"><a href="{{"portfolioDetail"}}">Web Application Design</a></h2>
                              <p>At Collax we specialize in designing, building, shipping...</p>
                              <a class="tp-btn-sm" href="{{"portfolioDetail"}}">View Case Studies <i class="far fa-arrow-right"></i></a>
                           </div>
                        </div>
                     ...
                     <div class="col-xl-6 col-lg-12">
                        <div class="row">
                           <div class=" col-xl-12 col-lg-12">
                              <div class="tp-project-box-sm d-flex align-items-center mb-20">
                                 <div class="tp-project-sm-img fix ml-25 mr-35">
                                    <img src="{{asset('user/assets/img/hero/brand-2.jpg')}}" alt="">
                                 </div>
                                 <div class="tp-project-sm-content">
                                    <h3 class="pro-sm-title"><a href="{{"portfolioDetail"}}">Globar Art Deisgn</a></h3>
                                    <p>At Collax we specialize in the most designing, building, shipping...</p>
                                    <a class="tp-btn-white-sm" href="{{"portfolioDetail"}}">Case Studies <i
                                          class="far fa-arrow-right"></i></a>
                                 </div>
                           ...
                           <div class="col-xl-12 col-lg-12">
                              <div class="tp-project-box-sm d-flex align-items-center">
                                 <div class="tp-project-sm-img fix ml-25 mr-35">
                                    <img src="{{asset('user/assets/img/hero/brand-3.jpg')}}" alt="">
                                 </div>
                                 <div class="tp-project-sm-content">
                                    <h3 class="pro-sm-title"><a href="{{"portfolioDetail"}}">Modern Branding Design</a></h3>
                                    <p>At Collax we specialize in the most designing, building, shipping...</p>
                                    <a class="tp-btn-white-sm" href="{{"portfolioDetail"}}">Case Studies <i
                                          class="far fa-arrow-right"></i></a>
                                 </div>
               ...
               <div class="project-tab-main">
                  <div class="row gx-1  ">
                     <div class="col-xl-6 col-lg-12">
                        <div class="tp-project-box mb-20">
                           <div class="tp-project-img fix mb-45">
                              <img class="w-100" src="{{asset('user/assets/img/project/app-1.jpg')}}" alt="">
                           </div>
                           <div class="tp-project-content ml-20">
                              <h2 class="pro-lg-title"><a href="{{"portfolioDetail"}}">Banking App Management</a></h2>
                              <p>At Collax we specialize in designing, building, shipping...</p>
                              <a class="tp-btn-sm" href="{{"portfolioDetail"}}">View Case Studies <i class="far fa-arrow-right"></i></a>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           <div class=" col-xl-12 col-lg-12">
                              <div class="tp-project-box-sm d-flex align-items-center mb-20">
                                 ...
                                 <div class="tp-project-sm-content">
                                    <h3 class="pro-sm-title"><a href="{{"portfolioDetail"}}">Financial App Deisgn</a></h3>
                                    <p>At Collax we specialize in the most designing, building, shipping...</p>
                                    <a class="tp-btn-white-sm" href="{{"portfolioDetail"}}">Case Studies <i
                                          class="far fa-arrow-right"></i></a>
                                 </div>
                           ...
                           <div class="col-xl-12 col-lg-12">
                              <div class="tp-project-box-sm d-flex align-items-center">
                                 <div class="tp-project-sm-img fix ml-25 mr-35">
                                    <img src="{{asset('user/assets/img/project/app-3.jpg')}}" alt="">
                                 </div>
                                 <div class="tp-project-sm-content">
                                    <h3 class="pro-sm-title"><a href="{{"portfolioDetail"}}">Yoga App Desgin</a></h3>
                                    <p>At Collax we specialize in the most designing, building, shipping...</p>
                                    <a class="tp-btn-white-sm" href="{{"portfolioDetail"}}">Case Studies <i
                                          class="far fa-arrow-right"></i></a>
                                 </div>
               ...
               <div class="swiper-wrapper">
                     ...
                     <div class="tp-testimonial-item">
                        <div class="tp-testi-meta d-flex justify-content-between mb-40">
                           <div class="tp-testi-icon-box d-flex align-items-center">
                              <div class="tp-testi-img mr-20"><img src="{{asset('user/assets/img/testimonial/testi-1.png')}}" alt="">
                              </div>
                  ...
                  <div class="swiper-slide">
                     <div class="tp-testimonial-item">
                        <div class="tp-testi-meta d-flex justify-content-between mb-40">
                           <div class="tp-testi-icon-box d-flex align-items-center">
                              <div class="tp-testi-img mr-20"><img src="{{asset('user/assets/img/testimonial/testi-2.jpg')}}" alt="">
                              </div>
                              <div class="tp-testi-client-position">
                                 <h3>Floyd Miles</h3>
                                 <h6>CEO of (Orix)</h6>
                  ...
                  <div class="swiper-slide">
                     <div class="tp-testimonial-item">
                        <div class="tp-testi-meta d-flex justify-content-between mb-40">
                           <div class="tp-testi-icon-box d-flex align-items-center">
                              <div class=" tp-testi-img mr-20"><img src="{{asset('user/assets/img/testimonial/testi-3.png')}}" alt="">
                              </div>
                              <div class="tp-testi-client-position">
                                 <h3>Albert Flores</h3>
                                 <h6>Founder of (Rirax)</h6>
               ...
               <div class="swiper-wrapper">
                  <div class="swiper-slide">
                     <div class="tp-testimonial-item">
                        <div class="tp-testi-meta d-flex justify-content-between mb-40">
                           <div class="tp-testi-icon-box d-flex align-items-center">
                              <div class="tp-testi-img mr-20"><img src="{{asset('user/assets/img/testimonial/testi-4.jpg')}}" alt="">
                              </div>
                              <div class="tp-testi-client-position">
                  ...
                  <div class="swiper-slide">
                     <div class="tp-testimonial-item">
                        <div class="tp-testi-meta d-flex justify-content-between mb-40">
                           <div class="tp-testi-icon-box d-flex align-items-center">
                              <div class="tp-testi-img mr-20"><img src="{{asset('user/assets/img/testimonial/testi-5.jpg')}}" alt="">
                              </div>
                              <div class="tp-testi-client-position">
                                 <h3>Jerome Bell</h3>
                                 <h6>CEO of (Orix)</h6>
                  ...
                  <div class="swiper-slide">
                     <div class="tp-testimonial-item">
                        <div class="tp-testi-meta d-flex justify-content-between mb-40">
                           <div class="tp-testi-icon-box d-flex align-items-center">
                              <div class=" tp-testi-img mr-20"><img src="{{asset('user/assets/img/testimonial/testi-6.jpg')}}" alt="">
                              </div>
                              <div class="tp-testi-client-position">
                                 <h3>Floyd Miles</h3>
                                 <h6>CEO of (Orix)</h6>
         ...
         <div class="row gx-40">
               ...
               <div class="tp-blog-box mb-30 wow tpfadeLeft" data-wow-duration=".6s" data-wow-delay=".4s">
                  <div class="tp-blog-item">
                     <div class="tp-blog-img fix mb-35">
                        <a href="#"> <img class="w-100" src="{{asset('user/assets/img/hero/blog-1.jpg')}}" alt=""></a>
                     </div>
                     ...
                     <div class="tp-blog-info">
                        <h3 class="tp-blog-title"><a href="{{'blogdetail'}}">How to add a count up animation the webflow site.</a>
                        </h3>
            ...
            <div class="col-xl-6 col-lg-6">
               <div class="tp-blog-box mb-30 wow tpfadeRight" data-wow-duration=".7s" data-wow-delay=".6s">
                  <div class="tp-blog-item">
                     <div class="tp-blog-img fix mb-35">
                        <a href="#"><img class="w-100" src="{{asset('user/assets/img/hero/blog-2.jpg')}}" alt=""></a>
                     </div>
                     <div class="tp-blog-meta d-flex justify-content-between mb-30">
                        <a href="#">Business</a>
                        <a class="tp-blog-meta-color" href="#">February. 20.2022</a>
                     ...
                     <div class="tp-blog-info">
                        <h3 class="tp-blog-title"><a href="{{'blogdetail'}}">How to grow your business with collax digital
                              solution.</a></h3>
                        <p>At Collax we specialize in designing, building, shipping and scaling beautiful, usable
                           products
                           with blazing-fast</p>
         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="tp-blog-button text-center mt-30">
                  <a class="tp-btn" href="{{'blogdetail'}}">View Case Studies</a>
               </div>
            </div>
         </div>
      </div>
   ...
   <div class="tp-news-letter-area pb-140 wow tpfadeUp" data-wow-duration=".7s" data-wow-delay=".4s">
      <div class="container">
         <div class="tp-news-letter-box p-relative" data-background="{{asset('user/assets/img/news/news-shape.png')}}">
            <div class="row">
               ...
               <div class="col-xl-6 col-lg-6 text-lg-end col-md-4  ">
                  <div class="tp-news-letter-img">
                     <img src="{{asset('user/assets/img/hero/news-1.png')}}" alt="">
                  </div>
               </div>
            </div>
            <div class="tp-news-shape-img">
               <img src="{{asset('user/assets/img/news/news-shape-2.png')}}" alt="">
            </div>
         </div>
      </div>
   </div>
